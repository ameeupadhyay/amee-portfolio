  ...
  return (
    <div className="max-w-contentContainer mx-auto px-4 py-24">
      ...
      <div className="flex justify-center items-center mt-10">
        <ArchiveCard
          title="GitLab Project Extraction In Csv Format"
          des="Spearheaded a project involving the extraction of GitLab project details, compiling them into a structured Data Frame,
 and subsequently converting the data into an Excel file."
          listItem={["Python", "Pandas", "gitlab.io"]}
        />
